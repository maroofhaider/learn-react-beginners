(function(g){var window=this;'use strict';var $qb=function(a,b){g.V.call(this,{I:"button",Ma:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],X:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},V:[{I:"svg",X:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},V:[{I:"g",X:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},V:[{I:"g",X:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
V:[{I:"path",X:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.J=a;this.Ta("click",this.onClick,this);this.updateValue("title",g.dU(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});this.addOnDisposeCallback(g.bU(b.Jd(),this.element))},arb=function(a){g.V.call(this,
{I:"div",
S:"ytp-miniplayer-ui"});this.og=!1;this.player=a;this.T(a,"minimized",this.yh);this.T(a,"onStateChange",this.XR)},brb=function(a){g.vV.call(this,a);
this.B=new g.GK(this);this.j=new arb(this.player);this.j.hide();g.oU(this.player,this.j.element,4);a.qg()&&(this.load(),g.Nu(a.getRootNode(),"ytp-player-minimized",!0))};
g.w($qb,g.V);$qb.prototype.onClick=function(){this.J.Qa("onExpandMiniplayer")};g.w(arb,g.V);g.k=arb.prototype;
...
g.k.xp=function(){};
g.k.ax=function(){};
g.k.JH=function(){return null};g.w(brb,g.vV);g.k=brb.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.Nu(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.uV("miniplayer",brb);})(_yt_player);
